...
# 사용법: ./scripts/start_poa.sh [노드 수] [옵션]
#
# 예시:
#   ./scripts/start_poa.sh 3      # 3개 노드로 PoA 시작
#   ./scripts/start_poa.sh 9      # 9개 노드로 PoA 시작
#   ./scripts/start_poa.sh 5 -f   # 5개 노드, DB 강제 초기화
#   ./scripts/start_poa.sh 3 -k   # 3개 노드, 기존 DB 유지
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        -k|--keep)
            ...
            ;;
        -h|--help)
            echo "사용법: ./scripts/start_poa.sh [노드 수] [옵션]"
            echo ""
            echo "옵션:"
            ...
            echo ""
            echo "예시:"
            echo "  ./scripts/start_poa.sh 3      # 3개 노드"
            echo "  ./scripts/start_poa.sh 9 -f   # 9개 노드, DB 초기화"
            exit 0
            ;;
        *)
            shift
